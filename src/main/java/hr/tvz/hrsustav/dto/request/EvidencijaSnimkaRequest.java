...
@ToString
@AllArgsConstructor
public class EvidencijaSnimkaRequest {
	@Schema(description = "ID evidencije snimke (null kod kreiranja)", example = "1")
	private Integer idEvidencijaSnimka;
	@Schema(description = "Datum početka razdoblja", example = "2024-07-01")
	private Date datumOd;
	@Schema(description = "Datum završetka razdoblja", example = "2024-07-31")
